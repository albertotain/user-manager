...
/**
 * Description of ButtonBreadcrumbHelper
 *
 * @author ATA
 */
class ButtoncrumbsHelper extends Helper {
  ...
  protected $_defaultConfig = [
      'templates' => [
          'wrapper' => '<div class="text-right  mt-4">{{content}}</div>',
          'item' => '<a class="btn btn-outline-dark btn-crumb ml-2 mb-2" href="{{url}}">{{title}}</a>',
          'itemWithoutLink' => '<button class="btn btn-outline btn-crumb" style="white-space: normal">{{title}}</button>',
      ]
  ];
  ...
  public function activo($estado) {
    return $estado ? '<span class="d-none">1</span><i class="fa fa-check-square text-navy fa-lg"></i>' : '<span class="d-none">0</span><i class="fa fa-window-close text-danger fa-lg"></i>';
  }
